...
function BlogDetail({data,dataHome,dataAboutUs,allTourHG}) {
  ...
  return (
    <div className="relative">
        ...
        <Banner bannerData={banner} title={'Blog Detail'}></Banner>
      <div>
        ...
        <div className='mx-[16.19vw] max-md:mx-[4.27vw]'>
          <div className='flex md:gap-[0.5vw] gap-[2.13vw] md:mb-[1vw] max-md:my-[4.27vw] mt-[1.56vw] mb-[1vw]'>
            <div className='md:h-[1.875vw] md:px-[1vw] md:py-[0.25vw] py-[1.067vw] px-[4.27vw] flex items-center justify-center md:gap-[0.625vw] md:rounded-[0.25vw] rounded-[1.067vw] bg-[#FFD220]'>
              <span className='text-[#171717] text-center md:text-[0.75vw] text-[3.2vw] font-medium leading-[150%]'>
                Tip and Review
              </span>
            </div>
            <div className='md:h-[1.875vw] md:px-[1vw] md:py-[0.25vw] py-[1.067vw] px-[4.27vw] flex items-center justify-center md:gap-[0.625vw] md:rounded-[0.25vw] rounded-[1.067vw] bg-[#FFD220]'>
        ...
        <div className='flex items-center justify-end'>
          <span className='text-[#171717]  md:text-[0.875vw] text-[3.73vw] font-bold md:leading-[1.25] leading-[1.42] uppercase md:mr-[0.81vw] mr-[3.47vw]'>
          share on it:
          </span>
          <div className='flex items-center'>
            <TwitterShare url={data?.link} title={data?.title}/>
            <FaceBookShare url={data?.link} title={data?.title}/>
            <LinkedInShare url={data?.link} title={data?.title}/>
          </div>
        </div>
        </div>
      </div>
