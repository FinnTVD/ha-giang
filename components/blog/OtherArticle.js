...
function OtherArticle({ dataOtherPost, slug, category }) {
  return (
    <section className='w-full px-[6.25rem] mt-[6.25rem] relative z-30'>
      ...
      />
      <div className='grid md:grid-cols-4 grid-cols-2 md:gap-x-[2.5rem] md:gap-y-[3rem] gap-x-[4.27rem] gap-y-[6.4rem] md:mt-[1.5rem] mt-[4.27rem] font-poppins'>
        {dataOtherPost &&
          dataOtherPost
      ...
      <div className='flex justify-center md:mt-[1.5rem] mt-[4.27rem]'>
        <Button
          ...
          className={'my-[0.87rem] w-fit h-[3rem] max-md:rounded-[2.133rem] max-md:flex-1 max-md:h-[11.73rem]'}
        />
      </div>
    </section>
  )
