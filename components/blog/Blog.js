...
function Blog({arrayCateInit,arrayCateSlug,dataHome,dataAboutUs,allTourHG}) {
  ...
  return (
    <div className="relative">
        ...
        <Banner bannerData={banner} title={'Our blog'}></Banner>
        <div className='relative'>
          <div className='relative z-10'>
            ...
            <div className='mx-[8.12vw] max-md:mx-[4.27vw] flex filter-blog gap-[2.5vw]' ref={eleRef}>
              <div className='flex flex-col'>
                <span className='text-[0.875vw] text-[#9B9B9B] uppercase font-[400] max-md:hidden'>Category</span>
            ...
            <div className='flex md:gap-[0.75vw] gap-[3.2vw] justify-center items-center relative md:mt-[4.5vw] mt-[8.53vw]'>
              {Array.from({ length: totalPage }, (_, index) => (
                <div
                  ...
                  className={`cursor-pointer md:w-[2.125vw] md:h-[2.125vw] w-[9.07vw] h-[9.07vw] rounded-[50%] flex justify-center items-center bg-[#17171] ${
