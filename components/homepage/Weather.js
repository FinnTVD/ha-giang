...
export default function Weather({ section7 }) {
  ...
  return (
    <section className='relative mt-[6.25rem] max-md:mt-[16rem] font-poppins'>
      ...
      />
      <Image
        className='w-[74.625rem] h-[27.25rem] object-cover rounded-[0.75rem] blur-sm mx-auto relative max-md:w-[91.46667rem] max-md:h-[54.93333rem] z-[5] mt-[1.88rem] max-md:rounded-[3.2rem]'
      ...
      <div className='relative z-[5] w-fit mx-auto mt-[1.56rem] max-md:mt-[5.33rem]'>
        <span className=' font-normal leading-[1.57] tracking-[0.00219rem] text-gray-scale-80 max-md:text-[3.73rem] max-md:tracking-[0.00933rem]'>
        ...
        <div className='flex gap-x-[1rem] max-md:gap-x-[4.27rem] mt-[0.75rem] max-md:mt-[3.2rem] max-md:t-[3.2rem] justify-center'>
          <div className='flex gap-x-[0.5rem] max-md:gap-x-[2.13rem] rounded-[10rem] p-[0.75rem] max-md:p-[3.2rem] bg-[#f9f9f9] items-center w-fit '>
            <Image
              className='w-[1.5rem] h-[1.5rem] max-md:w-[6.4rem] max-md:h-[6.4rem] rounded-full'
              src={'/images/sun.svg'}
              alt='sun'
              width={36}
              height={36}
            />
            <span className=' text-[0.875rem] max-md:text-[3.733rem] max-md:font-normal max-md:tracking-[0.00933rem] font-normal leading-[1.57] tracking-[0.00219rem] text-gray-scale-50'>
