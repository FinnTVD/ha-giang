        ...
        <section className='md:pl-[6.25vw] md:pr-[6.31vw] flex justify-between mt-[16vw] md:mt-[6.25vw] max-md:flex-col max-md:gap-[8vw] pr-[4.53333vw] pl-[4.26667vw]'>
            ...
            <div className='flex flex-col md:gap-[0.75vw] gap-[4.27vw]'>
                <div className='flex md:gap-[5vw] max-md:justify-between'>
                    ...
                    >
                        <h3
                            className={`md:text-[1.625vw] md:w-[26.375vw] text-[4.26667vw] md:font-semibold font-bold md:leading-[1.23] leading-[6.4vw] max-md:tracking-[0.05333vw] font-poppins text-[#B7B7B7] md:text-gray-scale-80 ${
                                active === 1 ? '!text-[#B34B1E] border-b border-[#B34B1E] ' : ''
                            }`}
                        >
                            NATURE
                        </h3>
                    ...
                    >
                        <h3
                            className={`md:text-[1.625vw] md:w-[26.375vw] text-[4.26667vw] md:font-semibold font-bold md:leading-[1.23] leading-[6.4vw] max-md:tracking-[0.05333vw] font-poppins text-[#B7B7B7] md:text-gray-scale-80 ${
                                active === 2 ? '!text-[#B34B1E] border-b border-[#B34B1E] ' : ''
                            }`}
                        >
                            JOURNEY
                        </h3>
                ...
                <div className='flex md:gap-[5vw]'>
                    {((active === 1 && isMobile) || !isMobile) && (
                        <div className='md:w-[26.375vw] w-full'>
