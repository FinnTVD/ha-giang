    ...
    return (
        <div className='relative z-[5]'>
            <Swiper
                ...
                modules={[FreeMode]}
                className='h-[14vw] mt-[2.5vw] max-md:h-[67.733vw]'
            >
                {arr?.map((e, index) => (
                    <SwiperSlide
                        className='rounded-[1vw] max-md:!w-[76.267vw]'
                        key={index}
                    >
                        <div className='w-full shadow-slideTrave h-full relative rounded-[1vw] overflow-hidden p-[1.56vw] bg-white flex flex-col items-center justify-center'>
                            <p className='text-[0.875vw] font-normal leading-[1.57] tracking-[0.00219rem]'>
                                Blown away by our Tanzania safari, I never expected it to be that good — it totally
                                exceeded my expectations and was all hassle free. Our guide was absolutely amazing too.
                                Have re-booked and cannot wait for next year! Camilla
                            </p>
