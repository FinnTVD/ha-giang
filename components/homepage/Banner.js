...
export default function Banner({ section1 }) {
  ...
  return (
    <>
      <div className='h-[6.25rem] w-full max-md:hidden'></div>
      <section
        ref={parentRef}
        className='h-screen relative z-[5] overflow-hidden max-md:mt-[5.33rem]'
      >
        <div
          id='box-title'
          className={`text-center uppercase text-primary-70 w-full relative z-[5] font-heavitas max-md:mt-[5.33rem]`}
        >
          <h3
            id='subtitle'
            className={`text-[1rem] leading-normal max-md:text-[3.2rem] font-extrabold mb-[0.75rem] max-md:mb-[2.13rem] max-md:text-white`}
          >
            {section1?.subTitle}
          </h3>
          <h2
            id='title'
            className={`text-[3rem] font-extrabold leading-[1] max-md:text-[6.4rem] max-md:leading-[1.17] max-md:text-white`}
          >
            {section1?.title}
          </h2>
        </div>
        <div className='w-full lg:relative h-fit'>
          <h2
            id='text-vn'
            className='font-tomatoes relative z-10 text-[16.0195rem] font-normal leading-normal tracking-[0.16019rem] text-[#ffd772] text-center mt-[2.19rem] max-md:text-[6.4rem] max-md:tracking-[0.064rem] max-md:text-white max-md:mt-[3.2rem]'
          >
            {section1?.heading}
          </h2>
          <div
            id='box-slide'
            className='h-[29.8125rem] w-[53rem] max-md:w-full max-md:h-[100vh] absolute bottom-[11rem] max-md:top-0 max-md:left-0 lg:translate-y-full left-1/2 lg:-translate-x-1/2 lg:rounded-[1rem]'
          >
            <SlideBanner
              section1={section1}
              isMobile={isMobile}
            ...
            <div
              id='overlay'
              className='absolute top-0 left-0 z-10 w-full h-0 opacity-50 bg-gradient-banner max-md:h-full lg:rounded-[1rem]'
            ></div>
          </div>
        </div>
        {!isMobile && (
