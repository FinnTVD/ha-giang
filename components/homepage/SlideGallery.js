            ...
            {section4?.listGallery?.map((e, index) => (
                ...
                >
                    <div className='w-full h-full relative rounded-[1vw] overflow-hidden max-md:rounded-[3.2vw]'>
                        ...
                        <div className='w-[11vw] h-[11vw] x-[2] absolute lg:top-1/2 left-1/2 -translate-x-1/2 lg:-translate-y-1/2 group-hover:opacity-100 opacity-0 transition-all duration-500 bg-[#cde82b99] scale-90 group-hover:scale-100 backdrop-blur-[3px] rounded-full max-md:w-[73.6vw] max-md:h-[73.6vw] max-md:bottom-[-44.8vw] max-md:opacity-100'></div>
