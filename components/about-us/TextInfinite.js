...
export default function TextInfinite({ textRun }) {
  return (
    <section className='flex flex-nowrap w-full h-[2.5rem] overflow-hidden relative mt-[6.1rem] max-md:hidden'>
      <div className='absolute left-0 top-0 whitespace-nowrap w-full h-full'>
        <div className='animate-scrollInfinite flex w-fit'>
          {array.map((item) => (
            <div className='flex items-center'>
              <div className='text-[#5FB01C] font-heavitas text-[2.625rem] leading-[1]'> {textRun} </div>
