...
export default function NavFixed({ setIsOpen, header, allTourHG }) {
  ...
  return (
    <nav
      ...
      } fixed left-1/2 top-0 -translate-x-1/2 transition-all duration-1000 z-[999] flex justify-center pt-[1.5rem] max-md:pt-[5.8rem] font-heavitas -translate-y-[150%] opacity-0 md:shadow-navFixed`}
    >
