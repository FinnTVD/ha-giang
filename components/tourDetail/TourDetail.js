  ...
  const listTourDetail = [
    {
      ...
      content: "8:00 PM: Everyone meets at Cheers Hostel Hanoi. Keep your bags here and have Free tea, coffee here all day. (No. 05 Au Trieu Str„ Hoan Kiem, Hanoi).8:30 PM: Get on best comfort Sleeper bus to Ha Giang. Checking in our Hotel in Ha Giang City in early morning around 3 AM and offering yourself a nap and breakfast before the tour starts.",
      categories :[
        {
          category : "From Hanoi",
          icon:homeLocation,
    ...
    <div className='flex flex-col'>
        ...
        <div className='flex flex-col md:gap-[2.5vw] max-md:mt-[4.68vw]'>
          {listTourDetail.map((tour,index)=> (
            <AboutTour key={index} title={tour?.title} subTitle={tour?.subTitle} content={tour?.content} categories={tour?.categories} />
          ))}
        </div>
    </div>
  )
